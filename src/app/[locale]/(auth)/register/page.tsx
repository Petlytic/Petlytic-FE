...
import { RegisterBackgroundCircles } from "./background-circle";
import { RegisterBrandingPanel } from "./branding-panel";

export default function RegisterPage() {
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-brand-blue-light p-4 sm:p-6 lg:p-8">
      <RegisterBackgroundCircles />
