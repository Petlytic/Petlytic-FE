...
function ServiceCard({ title, description, emoji, gradient, className = '', index }: ServiceCardProps) {
    ...
    >
      ...
      <div className="relative z-10 p-8 h-full flex flex-col justify-between">
        ...
        <div>
          ...
          >
            <span style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Learn More</span>
            <span>→</span>
          </motion.div>
        </div>
      </div>
  ...
  const services = [
    {
      ...
      description: 'Comprehensive health checkups and medical care by certified veterinarians.',
      emoji: '🏥',
    ...
    {
      title: 'Pet Spa',
      description: 'Relaxing spa treatments including massages and aromatherapy.',
      emoji: '🧖',
    ...
    {
      title: 'Nutrition',
      description: 'Custom meal plans and dietary consultations for optimal health.',
      emoji: '🍖',
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            From health care to pampering, we offer comprehensive services to keep your pets happy, healthy, and thriving.
          </p>
        </motion.div>
